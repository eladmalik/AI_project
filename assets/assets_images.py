...
CAR_IMG = pygame.image.load(os.path.join("assets", "orange-car-top-view.png"))
ICON_IMG = pygame.image.load(os.path.join("assets", "icon.png"))
FLOOR_IMG = pygame.image.load(os.path.join("assets", "floor.png"))
SIDEWALK_IMG = pygame.image.load(os.path.join("assets", "sidewalk3.png"))
SOLID_WHITE = pygame.image.load(os.path.join("assets", "solid_white.png"))
